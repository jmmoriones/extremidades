	...
	return `
		<div class="activaExtremidadS-content container-content_slide">
			<div class="activaExtremidadS-content_graphic activaExtremidadS-content_graphic--page2">
				...
				<img src="img/svg/womenBrazosAtras.svg" class="animate__animated animate__backInLeft animate__delay-1s" />
			</div>
			<div class="activaExtremidadS-content_description">
				...
				<div class="activaExtremidadS-content_description-excersice">
					...
					<p class="activaExtremidadS-content_description-excersice_text animate__animated animate__backInRight animate__delay-3s">Igualmente, con los codos rectos, lleva los brazos hacia atrás. Vuelve a la posición de partida</p>
				</div>
			</div>
		</div>
	`
