		...
		<div class="enTrabajo-content enTrabajoPage5-content container-content_slide">
			...
			<div class="enTrabajo-content_description enTrabajoPage5-content_description">
				...
				<ul class="enTrabajo-content_description-ul">
					<li class="enTrabajo-content_description-ul_li animate__animated animate__backInRight animate__delay-3s">Durante la digitación y manipulación del mouse, recuerde realizar movimientos en bloque.</li>
				</ul>
				<p class="enTrabajo-content_description-message animate__animated animate__bounceIn animate__delay-4s">Evita las desviaciones en muñecas</p>
			</div>
		</div>
	`
}