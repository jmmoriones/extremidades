		...
		<div class="usoCelular-content container-content_slide">
			...
			<div class="usoCelular-content_description">
				...
				<ul class="usoCelular-content_description-ul">
					...
					<li class="usoCelular-content_description-ul_li animate__animated animate__backInRight animate__delay-4s">Suavemente lleve la muñeca hacia abajo, sostén durante 10 – 15 segundos</li>
				</ul>
			</div>
		</div>
	`
