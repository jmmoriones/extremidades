	...
	return `
		<div class="activaExtremidadS-content container-content_slide">
			<div class="activaExtremidadS-content_graphic activaExtremidadS-content_graphic--page2">
				...
				<img src="img/svg/menMueveExtremidades.svg" class="animate__animated animate__backInLeft animate__delay-1s" />
			</div>
			<div class="activaExtremidadS-content_description">
				...
				<p class="activaExtremidadS-content_description-subTitle activaExtremidadS-content_description-subTitle--medium animate__animated animate__backInRight animate__delay-3s">Continúa la sesión con ejercicios de estiramiento muscular</p>
