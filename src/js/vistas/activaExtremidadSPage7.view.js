		...
		<div class="activaExtremidadS-content container-content_slide">
			...
			<div class="activaExtremidadS-content_description">
				...
				<div class="activaExtremidadS-content_description-excersice">
					...
					<p class="activaExtremidadS-content_description-excersice_text animate__animated animate__backInRight animate__delay-3s">Lleva las manos a los hombros, gire los hombros hacia adelante y luego hacia atrás</p>
				</div>
			</div>
		</div>
	`
