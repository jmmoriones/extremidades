	...
	return `
		<div class="cuidarExtremidades-content container-content_slide">
			<div class="cuidarExtremidades-content_description cuidarExtremidades-content_description--width">
				<p class="cuidarExtremidades-content_description-title cuidarExtremidades-content_description-title--blue">¿Y POR QUÉ ES TAN IMPORTANTE CUIDAR TUS EXTREMIDADES SUPERIORES?</p>
				<p class="cuidarExtremidades-content_description-text cuidarExtremidades-content_description-text--align">Las extremidades superiores son segmentos corporales importantes en nuestro cuerpo, constantemente requerimos de ellas para todas nuestras actividades de la vida diaria, siendo necesario su cuidado al desarrollar cualquier tarea u oficio. Los principales factores que inciden en la aparición de posibles molestias, pueden ser:</p>
				<ul class="cuidarExtremidades-content_description-list">
					...
					<li class="cuidarExtremidades-content_description-list_item">Factores individuales (edad, estilos de vida, género, condiciones hereditarias, entre otras).</li>
