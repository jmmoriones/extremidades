			...
			<div class="relajaExtremidadesS-content_description">
				...
				<div class="relajaExtremidadesS-content_description-excersice">
					...
					<ul class="activaExtremidadS-content_description-ul">
						...
						<li class="activaExtremidadS-content_description-ul_li animate__animated animate__backInRight animate__delay-4s">Con la mano contraria ejerce un poco de presión sobre todos los dedos, hasta que sientas algo de tensión</li>
						<li class="activaExtremidadS-content_description-ul_li animate__animated animate__backInRight animate__delay-4s">Mantén la posición y luego realiza el ejercicio con la otra mano</li>
					</ul>
					<p class="relajaExtremidadesS-content_description-excersice_message animate__animated animate__bounceIn animate__delay-5s"><b>Recuerda</b> también involucrar el dedo pulgar</p>
				</div>
			</div>
		</div>
	`
