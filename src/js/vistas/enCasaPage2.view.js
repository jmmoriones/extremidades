			...
			<div class="enCasa-content_description enCasa-content_descriptionPage2">
				...
				<div class="enCasa-content_description-excersice">
					...
					<ul class="enCasa-content_description-ul">
						<li class="enCasa-content_description-ul_li">Al practicar algún deporte o realizar actividad física, recuerda siempre incluir ejercicios de calentamiento y estiramiento muscular, previniendo lesiones musculo esqueléticas.</li>
						<li class="enCasa-content_description-ul_li">Durante la práctica de deportes o actividades de ocio que impliquen el uso frecuente de extremidades superiores, evita realizar movimientos forzados o sobre esfuerzos que puedan generar lesiones.</li>
					</ul>
				</div>
			</div>
		</div>
